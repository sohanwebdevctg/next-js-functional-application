...
const BlogGallery = () => {
  return (
    <div className="px-2 sm:px-4 md:px-4 my-10">
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3'>
          ...
          <div>
            ...
            <div className='h-44 sm:h-40 md:h-40 lg:h-48 xl:h-52 w-full relative mt-3'>
              <Image src={delivery} alt="this is delivery section" className='h-full w-full'></Image>
              <div className="absolute top-0 bottom-0 right-0 left-0 bg-black bg-opacity-55 flex items-end p-3">
              <ul>
          ...
          <div className='sm:hidden md:block'>
            ...
            <div className='h-44 md:h-full lg:h-full xl:h-full w-full relative'>
              <Image src={award} alt="this is award section" className='h-full w-full'></Image>
              <div className="absolute top-0 bottom-0 right-0 left-0 bg-black bg-opacity-55 flex items-end p-3">
              <ul>
          ...
          <div>
            ...
            <div className='h-44 sm:h-40 md:h-40 lg:h-48 xl:h-52 relative w-full'>
              <Image src={industry} alt="this is industry section" className='h-full w-full'></Image>
              <div className="absolute top-0 bottom-0 right-0 left-0 bg-black bg-opacity-55 flex items-end p-3">
              <ul>
            ...
            <div className='h-44 sm:h-40 md:h-40 lg:h-48 xl:h-52 w-full relative mt-3'>
              <Image src={working} alt="this is success section" className='h-full w-full'></Image>
              <div className="absolute top-0 bottom-0 right-0 left-0 bg-black bg-opacity-55 flex items-end p-3">
              <ul>
