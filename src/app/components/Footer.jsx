    ...
    <div className='bg-[#F5F5F5]'>
      ...
      <div className="container mx-auto">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 md:grid-cols-4 gap-3 sm:gap-2 md:gap-4 xl:gap-10 h-full w-full py-10 md:py-10 lg:py-10 xl:py-10 px-5 sm:px-5 md:px-5 lg:px-10 xl:px-12">
          ...
          {/* item3 section end */}
          {/* item4 section start */}
          <div className='bg-black bg-opacity-55 shadow-xl rounded-tl-[60px] rounded-br-[60px] pr-5 flex flex-col justify-center gap-3'>
            <ul className="text-right">
              <li><Link href="/" className="text-xs sm:text-[11px] md:text-[13px] lg:text-sm xl:text-sm text-gray-300">+8801632937291</Link></li>
              <li><Link href="/" className="text-xs sm:text-[11px] md:text-[13px] lg:text-sm xl:text-sm text-red-500">xcodeemail@gmail.com</Link></li>
            </ul>
            <ul className="text-right">
              <li><Link href="/" className="text-xs sm:text-[11px] md:text-[13px] lg:text-sm xl:text-sm text-gray-300">900-140 10th Avenue SE</Link></li>
              <li><Link href="/" className="text-xs sm:text-[11px] md:text-[13px] lg:text-sm xl:text-sm text-gray-300">Calgary, AB T2G OR1</Link></li>
            </ul>
          </div>
          {/* item4 section end */}
