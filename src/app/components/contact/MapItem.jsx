...
const MapItem = () => {
  return (
    <div className='h-96 sm:px-4 md:px-4 w-[90%] mx-auto text-center my-20'>
      {/* content section start */}
      <div className='container mx-auto py-8 px-3 sm:px-5 md:px-4 lg:px-10 xl:px-8 h-full w-full bg-white shadow-lg'>
