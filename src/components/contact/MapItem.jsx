...
const MapItem = () => {
  return (
    <div className='h-96 sm:h-80 md:h-80 lg:h-96 xl:h-96 sm:px-4 md:px-4 w-[90%] mx-auto text-center my-16 sm:my-16 md:my-16 lg:my-20 xl:my-20'>
      {/* content section start */}
      <div className='container mx-auto py-4 px-4 sm:py-6 sm:px-6 md:py-7 md:px-7 lg:py-8 lg:px-8 xl:py-7 xl:px-7 h-full w-full bg-white shadow-lg'>
